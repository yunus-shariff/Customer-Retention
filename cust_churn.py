...
data = pd.read_csv('/Users/y-unus/Documents/FS2022_Classes/CMSE830 - Foundations of DS/Projects/Final/Customer-Churn-Prediction-and-Analysis-main/Telco Customer Churn.csv')
...
fig = px.bar(x=df_sorted['Feature Importance'], y=df_sorted['Features'], color_continuous_scale=px.colors.sequential.Blues,
             title='<b>Feature Engineering<b>', text_auto='.4f', color=df_sorted['Feature Importance'])
